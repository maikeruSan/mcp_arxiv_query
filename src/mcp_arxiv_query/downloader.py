...
class ArxivDownloader:
    ...
    def download_paper(self, paper_id: str, filename: Optional[str] = None, 
                      max_retries: int = 3, retry_delay: int = 2) -> Dict[str, str]:
        """
    ...
    def download_papers_batch(self, paper_ids: list, 
                             delay_between_downloads: float = 1.0) -> Dict[str, Dict[str, str]]:
        """
